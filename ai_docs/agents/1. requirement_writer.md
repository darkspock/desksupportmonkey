...
- Epics: `docs/epics/{epic-name}/requirements.md`
- Features: `docs/epics/{epic-name}/features/{feature-name}/requirements.md`
- Hotfixes: `docs/hotfixes/{name}/requirements.md`
- Cases: `docs/cases/{name}/requirements.md`

See `ai_docs/development_process.md` for the full output location reference.
