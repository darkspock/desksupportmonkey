...
- [ ] **File:** `src/company_bc/company/domain/billing_enums.py` (NEW)
...
- [ ] **File:** `src/company_bc/company/domain/plan_gate.py` (NEW)
...
- [ ] **File:** `src/company_bc/company/infrastructure/repository.py` (MODIFY)
- Add:
...
- [ ] **File:** `src/company_bc/company/domain/repository.py` (MODIFY)
...
- [ ] Run: `alembic revision --autogenerate -m "add_billing_fields_to_companies_and_processed_stripe_events"`
...
- [ ] **File:** `tests/unit/company_bc/company/domain/test_plan_gate.py` (NEW)
...
- [ ] **File:** `tests/unit/company_bc/company/domain/test_company_billing.py` (NEW)
...
### T6.1: Run linter
- [ ] `make lint` — mypy + flake8 pass

### T6.2: Run unit tests
- [ ] `make test` — all tests pass

### T6.3: Run migration
- [ ] `alembic upgrade head` + downgrade/upgrade cycle — reversible
