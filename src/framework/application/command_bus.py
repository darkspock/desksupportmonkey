...
class CommandHandler(ABC, Generic[TCommand]):
    ...
    Commands should return None (CQRS pattern).
    """
    ...
    def handle(self, command: TCommand) -> None:
        ...
        Returns:
            None - CQRS commands do not return values.
            Use pre-generated IDs passed in the command for entity creation.
        """
        pass
...
class CommandBus:
    ...
    def dispatch_with_events(self, command: Any) -> tuple[Any, list]:
    ...
    def _dispatch_internal(self, command: Any) -> tuple[Any, list]:
