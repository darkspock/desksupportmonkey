...
@dataclass
class UnpublishArticleCommand(Command):
    article_id: str
    company_id: str


class UnpublishArticleCommandHandler(CommandHandler[UnpublishArticleCommand]):
    def __init__(self, article_repo: ArticleRepositoryInterface):
        self.article_repo = article_repo

    def handle(self, command: UnpublishArticleCommand) -> None:
