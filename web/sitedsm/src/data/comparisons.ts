...
export const comparisons: ComparisonData[] = [
  {
    slug: 'excel',
    competitor: 'Excel / Hojas de cálculo',
    ...
    subtitle: {
      es: 'Por qué una hoja de cálculo no es suficiente para cumplir NIS2',
      en: 'Why a spreadsheet is not enough for NIS2 compliance',
    },
    intro: {
      es: 'El 67% de las PYMEs europeas gestionan sus activos IT en hojas de cálculo. Funciona hasta que un auditor pide trazabilidad, un portátil desaparece, o NIS2 exige documentar cada incidencia vinculada a un dispositivo. Excel no fue diseñado para esto.',
    ...
    dsm_summary: {
      es: 'Plataforma completa de gestión del ciclo de vida de activos TIC con trazabilidad NIS2, incidencias vinculadas a dispositivos y audit trail exportable.',
    ...
    competitor_summary: {
      es: 'Hoja de cálculo genérica. Flexible pero sin estructura, sin audit trail, sin vinculación entre incidencias y activos, sin control de versiones real.',
    ...
    features: [
      ...
      { name: { es: 'Audit trail automático', en: 'Automatic audit trail' }, dsm: true, competitor: false },
      ...
      { name: { es: 'Múltiples usuarios simultáneos', en: 'Multiple simultaneous users' }, dsm: true, competitor: '⚠️' },
      ...
      { name: { es: 'Dashboard con métricas', en: 'Dashboard with metrics' }, dsm: true, competitor: false },
      { name: { es: 'Exportación para auditores NIS2', en: 'NIS2 auditor export' }, dsm: true, competitor: false },
    ...
    verdict: {
      es: 'Excel funciona para 5 portátiles. No funciona cuando un auditor NIS2 pide trazabilidad completa de cada dispositivo y cada incidencia. DSM Control convierte tu inventario caótico en un sistema de compliance en menos de un día.',
    ...
    best_for_dsm: {
      es: 'Empresas de +10 empleados que necesitan compliance NIS2 o simplemente quieren dejar de gestionar activos en hojas de cálculo.',
  ...
  },
  {
    ...
    subtitle: {
      es: 'Gestión de activos TIC sin la trampa del pricing por agente',
      en: 'IT asset management without the per-agent pricing trap',
    },
    intro: {
      es: 'Freshservice es una herramienta ITSM excelente, pero su pricing penaliza a las PYMEs: cobran por agente ($19-119/mes) Y por activos ($75-1,500/mes adicionales). Una empresa de 50 empleados con 3 técnicos puede acabar pagando €400-600+/mes. DSM Control cobra por tamaño de empresa: €99/mes para hasta 100 empleados, todo incluido.',
    ...
    dsm_summary: {
      es: 'Plataforma de gestión de activos TIC con ciclo de vida completo, incidencias vinculadas y NIS2. Precio fijo por tamaño de empresa.',
      en: 'IT asset management platform with full lifecycle, linked incidents, and NIS2. Flat pricing by company size.',
    },
    competitor_summary: {
      es: 'ITSM completo (tickets, problemas, cambios, releases) con módulo de activos. Potente pero caro para PYMEs. Sin posicionamiento NIS2.',
    ...
    features: [
      ...
      { name: { es: 'Gestión de cambios (ITIL)', en: 'Change management (ITIL)' }, dsm: false, competitor: true },
    ...
    pricing_competitor: {
      es: 'Starter $19/agente/mes + Asset Management desde $75/mes (500 activos). Enterprise: $119/agente/mes + $1,500/mes activos ilimitados. Una empresa de 50 personas con 3 técnicos: ~$432-1,857/mes.',
    ...
    verdict: {
      es: 'Freshservice es ideal si necesitas ITIL completo (cambios, problemas, releases) y tienes presupuesto enterprise. Si lo que necesitas es gestionar activos, vincular incidencias y cumplir NIS2 sin gastar +€400/mes, DSM Control hace exactamente eso a una fracción del coste.',
    ...
    best_for_dsm: {
      es: 'PYMEs de 10-300 empleados que necesitan gestión de activos + incidencias + compliance NIS2 con un pricing predecible.',
  ...
  },
  {
    ...
    intro: {
      es: 'Snipe-IT es el proyecto open source de gestión de activos más popular (~12,000 estrellas en GitHub) y tiene un ciclo de vida sólido. Pero tiene una carencia crítica: no tiene gestión de incidencias. No puedes vincular un ticket a un activo. Es la limitación más citada en sus reviews. DSM Control une ambos mundos.',
    ...
    competitor_summary: {
      es: 'Inventario de activos open source excelente. Check-in/out, licencias, garantías. Pero cero gestión de incidencias o tickets.',
    ...
    features: [
      ...
      { name: { es: 'Gestión de incidencias', en: 'Incident management' }, dsm: true, competitor: false },
      { name: { es: 'Incidencias vinculadas a activos', en: 'Incidents linked to assets' }, dsm: true, competitor: false },
      { name: { es: 'NIS2 audit trail', en: 'NIS2 audit trail' }, dsm: true, competitor: false },
      { name: { es: 'Órdenes de compra', en: 'Purchase orders' }, dsm: true, competitor: true },
      ...
      { name: { es: 'Gestión de licencias software', en: 'Software license management' }, dsm: false, competitor: true },
    ],
    pricing_dsm: {
    ...
    verdict: {
      es: 'Si solo necesitas un inventario de activos, Snipe-IT es una opción sólida y madura. Pero si necesitas vincular incidencias a dispositivos — que es exactamente lo que exige NIS2 — Snipe-IT no puede hacerlo. DSM Control es Snipe-IT + un módulo completo de incidencias + NIS2 compliance.',
    ...
    best_for_dsm: {
      es: 'Empresas que necesitan inventario + incidencias + compliance en una sola herramienta, sin integrar múltiples productos.',
      en: 'Companies that need inventory + incidents + compliance in a single tool, without integrating multiple products.',
    },
    best_for_competitor: {
      es: 'Equipos que solo necesitan inventario puro de hardware/software y gestión de licencias, sin módulo de incidencias.',
  ...
  },
  {
    ...
    intro: {
      es: 'Lansweeper es el competidor más fuerte en narrativa NIS2: tiene páginas dedicadas, checklists y contenido de compliance. Pero es fundamentalmente una herramienta de descubrimiento de red. No tiene service desk, no vincula incidencias a activos, y no gestiona el ciclo de vida (compra, asignación, baja). Para eso necesitas integrarlo con Freshservice o Jira.',
    ...
    competitor_summary: {
      es: 'Herramienta de descubrimiento y auditoría de red. Escanea dispositivos automáticamente. Fuerte en NIS2 marketing. Sin service desk ni ciclo de vida.',
    ...
    features: [
      ...
      { name: { es: 'Incidencias vinculadas a activos', en: 'Incidents linked to assets' }, dsm: true, competitor: false },
      { name: { es: 'Ciclo de vida completo', en: 'Full lifecycle management' }, dsm: true, competitor: false },
      { name: { es: 'Órdenes de compra y proveedores', en: 'Purchase orders and vendors' }, dsm: true, competitor: false },
      { name: { es: 'Mantenimiento preventivo', en: 'Preventive maintenance' }, dsm: true, competitor: false },
    ...
    pricing_competitor: {
      es: 'Free hasta 100 activos. Starter €199/mes. Pro y Enterprise: contactar ventas (estimación: €500+/mes para PYMEs).',
      en: 'Free up to 100 assets. Starter €199/month. Pro and Enterprise: contact sales (estimate: €500+/month for SMBs).',
    },
    verdict: {
      es: 'Lansweeper es excelente si tu prioridad es descubrir qué hay en tu red automáticamente. Pero NIS2 no solo pide saber qué tienes — pide documentar quién lo usa, qué incidencias ha tenido, y todo su historial. DSM Control cubre lo que Lansweeper no puede: el ciclo de vida completo con incidencias vinculadas.',
    ...
    best_for_dsm: {
      es: 'PYMEs que necesitan gestionar el ciclo de vida completo de sus activos con incidencias y compliance, sin pagar €500+/mes ni integrar múltiples herramientas.',
    ...
    best_for_competitor: {
      es: 'Empresas medianas/grandes con equipos de seguridad que priorizan descubrimiento automático de red y ya tienen un ITSM separado.',
  ...
  },
  {
    ...
    competitor_summary: {
      es: 'Funcionalidad completa pero stack PHP legacy, UX datada, requiere instalación y mantenimiento DevOps. Sin NIS2. Cloud es un afterthought.',
    ...
    features: [
      ...
      { name: { es: 'NIS2 audit trail', en: 'NIS2 audit trail' }, dsm: true, competitor: false },
      { name: { es: 'SaaS cloud sin instalación', en: 'SaaS cloud, no installation' }, dsm: true, competitor: '⚠️' },
      ...
      { name: { es: 'Comunidad establecida (20+ años)', en: 'Established community (20+ years)' }, dsm: false, competitor: true },
    ],
    pricing_dsm: {
      es: 'Starter €49/mes · Growth €99/mes · Scale €199/mes. Self-hosted gratis (AGPL).',
      en: 'Starter €49/mo · Growth €99/mo · Scale €199/mo. Self-hosted free (AGPL).',
    ...
    pricing_competitor: {
      es: 'Self-hosted gratis (GPLv3). Cloud: GLPI Network desde €19/mes (básico) hasta €45+/mes con soporte.',
      en: 'Self-hosted free (GPLv3). Cloud: GLPI Network from €19/month (basic) to €45+/month with support.',
    },
    verdict: {
      es: 'GLPI tiene una funcionalidad comparable. Si ya lo tienes instalado y funcionando, no hay razón urgente para migrar. Pero si estás evaluando herramientas desde cero, DSM Control ofrece la misma cobertura funcional con una experiencia moderna, SaaS-first, NIS2 ready, y sin necesidad de mantener un servidor PHP.',
    ...
    best_for_dsm: {
      es: 'Empresas que evalúan herramientas por primera vez y quieren SaaS moderno con compliance NIS2 sin gestión de infraestructura.',
