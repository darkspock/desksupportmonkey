...
export const complianceData: ComplianceData[] = [
  ...
  // ─── DORA ───────────────────────────────────────────
  {
    ...
    headline: {
      es: 'Por qué necesitas DSM Control para cumplir DORA',
      en: 'Why you need DSM Control for DORA compliance',
    },
    subtitle: {
      es: 'DORA exige a las entidades financieras identificar, clasificar y documentar todos sus activos TIC. DSM Control proporciona el inventario, la gestión de incidencias y la trazabilidad que DORA requiere.',
    ...
    who: {
      title: { es: 'Quién debe cumplir', en: 'Who must comply' },
      items: [
        { es: 'Bancos e instituciones de crédito', en: 'Banks and credit institutions' },
        { es: 'Compañías de seguros y reaseguros', en: 'Insurance and reinsurance companies' },
        { es: 'Empresas de inversión, gestoras de fondos, fintechs', en: 'Investment firms, fund managers, fintechs' },
        { es: 'Instituciones de pago, entidades de dinero electrónico, proveedores de servicios de criptoactivos', en: 'Payment institutions, e-money institutions, crypto-asset service providers' },
        { es: 'Proveedores de servicios TIC críticos para el sector financiero (cloud, SaaS, centros de datos)', en: 'Critical ICT third-party providers to the financial sector (cloud, SaaS, data centers)' },
      ],
    },
    penalties: {
      title: { es: 'Sanciones', en: 'Penalties' },
      items: [
        ...
        { es: 'Proveedores TIC críticos: hasta 5M EUR o 1% de la facturación media diaria mundial durante hasta 6 meses', en: 'Critical ICT providers: up to €5M or 1% of average daily worldwide turnover for up to 6 months' },
        { es: 'Los órganos de dirección son personalmente responsables del cumplimiento de la gestión de riesgos TIC', en: 'Management bodies are personally responsible for ICT risk management compliance' },
    ...
    mappings: {
      ...
      subtitle: {
        es: 'DORA se estructura en 5 pilares. DSM Control proporciona capacidades directas para los tres más relevantes: gestión de riesgos TIC, gestión de incidencias y riesgo de terceros.',
      ...
      items: [
        {
          requirement: { es: 'Art. 8(1) — Identificación de activos TIC', en: 'Art. 8(1) — ICT asset identification' },
          meaning: { es: '"Las entidades financieras identificarán, clasificarán y documentarán adecuadamente todos los activos TIC"', en: '"Financial entities shall identify, classify and adequately document all ICT assets"' },
          feature: { es: 'Inventario completo de activos TIC', en: 'Complete ICT asset inventory' },
          how: { es: 'Inventario centralizado con clasificación, propietario, ubicación, estado y metadatos completos. Este es el requisito fundacional del marco de gestión de riesgos de DORA.', en: 'Centralized inventory with classification, owner, location, status, and full metadata. This is the foundational requirement of DORA\'s risk management framework.' },
        },
        {
          requirement: { es: 'Art. 8(4) — Identificación continua de riesgos TIC', en: 'Art. 8(4) — Continuous ICT risk identification' },
          ...
          how: { es: 'Cuando se divulga una vulnerabilidad, busca por fabricante + modelo + versión de firmware. Los dispositivos afectados se identifican en segundos, no en días.', en: 'When a vulnerability is disclosed, search by manufacturer + model + firmware version. Affected devices identified in seconds, not days.' },
        },
        {
          requirement: { es: 'Art. 9 — Protección y prevención', en: 'Art. 9 — Protection and prevention' },
          ...
          how: { es: 'Seguimiento del estado de cada activo, planes de mantenimiento programados, alertas de garantía y edad. La infraestructura de red (routers, switches, firewalls) se documenta con ubicación y conexiones.', en: 'Status tracking per asset, scheduled maintenance plans, warranty and age alerts. Network infrastructure (routers, switches, firewalls) documented with location and connections.' },
        },
        {
          requirement: { es: 'Art. 17 — Proceso de gestión de incidencias TIC', en: 'Art. 17 — ICT incident management process' },
          ...
          how: { es: 'Incidencia creada contra activo específico, clasificación, asignación a técnico, seguimiento de estado, resolución. Cada paso con timestamp. Timeline completa exportable.', en: 'Incident created against specific asset, classification, assignment to technician, status tracking, resolution. Every step timestamped. Full timeline exportable.' },
        },
        {
          requirement: { es: 'Art. 19 — Notificación de incidencias graves', en: 'Art. 19 — Major incident reporting' },
          meaning: { es: 'Notificación inicial en 4 horas, informe intermedio en 72 horas, informe final en 1 mes', en: 'Initial notification within 4 hours, intermediate report within 72 hours, final report within 1 month' },
          feature: { es: 'Timeline de incidencias con timestamps', en: 'Incident timeline with timestamps' },
          how: { es: 'El timestamp de creación documenta cuándo se identificó la incidencia. La vinculación a activos muestra qué sistemas fueron afectados. La timeline proporciona la base de evidencia para el reporte regulatorio.', en: 'Creation timestamp documents when incident was identified. Asset linkage shows which systems were affected. Timeline provides the evidence base for regulatory reporting.' },
        },
        {
          ...
          how: { es: 'Cada activo es trazable a su proveedor y orden de compra. Si un proveedor sufre un incidente de seguridad, sabes inmediatamente qué activos están afectados.', en: 'Every asset traceable to its vendor and purchase order. If a vendor suffers a security incident, you immediately know which assets are affected.' },
        },
      ],
    },
    auditor: {
      title: { es: 'Qué espera el supervisor en una inspección DORA', en: 'What the supervisor expects in a DORA inspection' },
      questions: [
        {
          question: { es: 'Muéstrame tu registro de activos TIC (Artículo 8)', en: 'Show me your ICT asset register (Article 8)' },
          without: { es: 'Archivo Excel, posiblemente desactualizado, sin clasificación', en: 'Excel file, possibly outdated, no classification' },
          with: { es: 'Inventario en vivo con clasificación, propietarios y ubicaciones — siempre actualizado', en: 'Live inventory with classification, owners, and locations — always current' },
        },
        {
          question: { es: '¿Cómo identificáis qué activos están afectados cuando se divulga una vulnerabilidad?', en: 'How do you identify which assets are affected when a vulnerability is disclosed?' },
          without: { es: 'Investigación manual, llamadas, búsquedas en hojas de cálculo. Días.', en: 'Manual investigation, phone calls, spreadsheet searches. Days.' },
        ...
        {
          question: { es: '¿Cuál es vuestra exposición al proveedor X? (Artículo 28)', en: 'What is your exposure to provider X? (Article 28)' },
          without: { es: '"Déjame comprobarlo..." — días de investigación', en: '"Let me check..." — days of investigation' },
          with: { es: 'Filtro de activos por proveedor. Visibilidad inmediata: cuántos dispositivos, dónde, quién los tiene.', en: 'Filter assets by vendor. Instant visibility: how many devices, where, who has them.' },
        },
        {
          question: { es: 'Demuéstrame el proceso de gestión de incidencias TIC (Artículo 17)', en: 'Demonstrate your ICT incident management process (Article 17)' },
          ...
          with: { es: 'Incidencia creada contra activo específico, timeline completa con cada acción documentada', en: 'Incident created against specific asset, full timeline with every action documented' },
        },
      ],
    },
    gaps: {
      ...
      items: [
        {
          ...
          risk: { es: 'No puede demostrar cumplimiento del Artículo 8 — el requisito fundacional', en: 'Cannot demonstrate Article 8 compliance — the foundational requirement' },
          solution: { es: 'Inventario centralizado con todos los activos TIC, clasificación, propietarios y metadatos', en: 'Centralized inventory with all ICT assets, classification, owners, and metadata' },
        },
        {
          gap: { es: 'Activos sin clasificar por criticidad', en: 'Assets not classified by criticality' },
          risk: { es: 'No puede evaluar el impacto operativo de incidencias (Artículo 18)', en: 'Cannot assess operational impact of incidents (Article 18)' },
          solution: { es: 'Campos de clasificación de activos con niveles de criticidad', en: 'Asset classification fields with criticality levels' },
        },
        {
          gap: { es: 'Incidencias no vinculadas a activos', en: 'Incidents not linked to assets' },
          risk: { es: 'No puede demostrar qué sistemas se vieron afectados (Artículo 17-19)', en: 'Cannot demonstrate which systems were affected (Articles 17-19)' },
          solution: { es: 'Incidencias nativamente vinculadas a activos — evaluación de impacto basada en datos reales', en: 'Incidents natively linked to assets — impact assessment based on real asset data' },
        },
        {
          gap: { es: 'Sin visibilidad de proveedores', en: 'No vendor visibility' },
          risk: { es: 'No puede gestionar el riesgo de terceros TIC (Artículo 28)', en: 'Cannot manage ICT third-party risk (Article 28)' },
        ...
        },
        {
          ...
          risk: { es: 'Días para evaluar la exposición, no puede cumplir plazos del Art. 19 (4h/72h)', en: 'Days to assess exposure, cannot meet Article 19 timelines (4h/72h)' },
          solution: { es: 'Búsqueda instantánea por fabricante, modelo, firmware — dispositivos afectados en segundos', en: 'Instant search by manufacturer, model, firmware — affected devices in seconds' },
        },
        {
          gap: { es: 'Sin audit trail', en: 'No audit trail' },
    ...
    timeline: {
      ...
      items: [
        ...
        { date: 'Mar 2026', event: { es: 'DSM Control disponible — capacidad inmediata de cumplimiento del Artículo 8', en: 'DSM Control available — immediate Article 8 compliance capability' } },
    ...
    summary: {
      title: { es: 'Conclusión', en: 'Summary' },
      text: {
        es: 'DORA convierte la gestión de activos TIC en un requisito regulatorio para todo el sector financiero europeo. El mandato del Artículo 8 de "identificar, clasificar y documentar adecuadamente todos los activos TIC" no es opcional — es la base de todo el marco de compliance DORA. DSM Control proporciona la capa de implementación: identificar (inventario completo), clasificar (criticidad y función de negocio), documentar (ciclo de vida completo), monitorizar (mantenimiento y estado), responder (incidencias vinculadas a activos) y demostrar (audit trail). DORA es aplicable desde enero de 2025. Cada día sin una gestión adecuada de activos TIC es un día de exposición regulatoria.',
